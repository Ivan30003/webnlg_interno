...
from metrics.webnlg_2023.evaluation.automatic.scripts.metrics.chrF import computeChrF
...
def set_meteor_path(meteor_path):
    global METEOR_PATH
...
def meteor_score(references, hypothesis, num_refs, meteor_path, lng='en'):
    ...
    for refs in references:
        linear_references += refs + [""] * (num_refs - len(refs))
